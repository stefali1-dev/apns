    ...
    return (
        ...
        >
            ...
            <div className="p-6">
                ...
                <p className="text-gray-700 font-medium mb-4 text-sm line-clamp-2">
                    {member.position || 'Position not specified'}
                </p>
                <button className="cursor-pointer w-full bg-[#09a252] text-white py-2.5 px-4 rounded-lg hover:bg-green-700 transition-colors duration-200 font-medium text-sm">
                    Citește mai mult
                </button>
            </div>
        </div>
